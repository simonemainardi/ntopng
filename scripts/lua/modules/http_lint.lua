...
-- OTHER
   ...
   ["alert_type"]              =  validateSingleWord,            -- An alert type enum
   ["alert_severity"]          =  validateSingleWord,            -- An alert severity enum
   ["entity"]                  =  validateSingleWord,            -- An alert entity type
