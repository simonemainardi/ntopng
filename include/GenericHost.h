...
class GenericHost : public GenericHashEntry, public GenericTrafficElement {
 protected:
  ...
  u_int32_t host_serial, num_alerts_engaged;
  nDPIStats *ndpiStats;
 ...
 public:
  ...
  inline void incNumAlerts()          { num_alerts_engaged++;              };
  inline void decNumAlerts()          { num_alerts_engaged--;              };
  inline u_int32_t getNumAlerts()     { return num_alerts_engaged;         };
